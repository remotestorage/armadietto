...
class Armadietto {
  ...
  async dispatch (req, res) {
    ...
    let pathname = new URL(req.url, `http://${this._options.http.host}${req.url}`).pathname;
    ...
    new Assets(this, req, res).errorPage(404, locals, `no handler for path '${uri.pathname}'`);
 }
