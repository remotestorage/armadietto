...
//   document.getElementById('login').hidden = false;
  ...
  displayMessage('Click the button below to log in with a passkey. If you need to create a passkey on this device or browser, request another invitation using the link above.');
// });
