...
class Controller {
  ...
  renderHTML (status, file, locals = {}, logNote = '', logLevel = undefined) {
    ...
    const headers = {
      ...
      'Content-Security-Policy': "sandbox allow-scripts allow-forms allow-popups allow-same-origin; default-src 'none'; script-src 'self'; img-src 'self'; style-src 'self'; font-src 'self'; object-src 'none'; child-src 'none'; connect-src 'none'; base-uri 'self'; frame-ancestors 'none';",
