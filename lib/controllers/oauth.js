...
class OAuth extends Controller {
  ...
  authenticate () {
    ...
    this.server._store.authenticate({username: username, password: params.password}, error => {
      if (error) {
        ...
        this.server._store.authorize(params.client_id, username, permissions,(error, token) => {
          var args = {
            access_token: token,
            token_type:   'bearer',
          }
