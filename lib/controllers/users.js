...
class Users extends Controller {
  ...
  async register () {
    ...
    try {
      ...
      this.renderHTML(201, 'signup-success.html', { title: 'Signup Success', params: this.params });
    } catch (error) {
      this.renderHTML(409, 'signup.html', { title: 'Signup Failure', params: this.params, error, message: error.message });
    }
  }
}
