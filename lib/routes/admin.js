    ...
    async (req, res) => {
      ...
      try {
        ...
        res.status(401).render('login/error.html', {
          ...
          message: 'Request another invitation from an administrator.'
        });
      }
    }
  );
      ...
      try {
        ...
        if (privilegeGrant.ADMIN) {
          ...
          text = req.body.username
            ? `${req.body.username}, to create a passkey for ${hostIdentity} on a new device, copy and paste this URL into the browser on that device:`
